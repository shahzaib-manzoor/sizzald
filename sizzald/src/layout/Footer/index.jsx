    ...
    <>
      ...
      >
        ...
        <Box>
          ...
          <Box>
            {casino.map((Sport,i) => {
              return <Typography key={`${i}`} sx={subnav}>{Sport.sport}</Typography>;
            })}
          </Box>
        </Box>
        {/* third */}
        <Box>
          ...
          <Box>
            {casino.map((promo,i) => {
              return <Typography key={`${i}`} sx={subnav}>{promo.promo}</Typography>;
            })}
          </Box>
        </Box>
        {/* fourth */}
        <Box>
          ...
          <Box>
            {casino.map((support,i) => {
              return <Typography key={`${i}`} sx={subnav}>{support.support}</Typography>;
            })}
          </Box>
        </Box>
        {/* five */}
        <Box sx={{ marginRight: '20px' }}>
          ...
          <Box>
            {casino.map((about,i) => {
              return <Typography key={`${i}`} sx={subnav}>{about.about}</Typography>;
            })}
          </Box>
        </Box>
      </Box>
